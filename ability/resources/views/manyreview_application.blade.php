...
<div class="col-md-3">
    <div class="card-body bg-white shadow">
        ...
        @endif
        <a href="{{ route('application.detailpage', ['id' => $manyreview_application->trackId]) }}"><img class="d-block mx-auto img-thumbnail m-3 shadow-sm" src={{ $manyreview_application->artworkURL512}} width="125" height="125"></a>
        <a href="{{ route('application.detailpage', ['id' => $manyreview_application->trackId]) }}">
